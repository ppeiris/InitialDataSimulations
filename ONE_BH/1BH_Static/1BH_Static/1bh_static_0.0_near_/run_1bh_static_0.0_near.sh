...
# ==================================
START=$(date +%s)
echo "Simulation ManyBHnear_1bh_static_0.0_near_2x3x5 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/manybhnear_1bh_static_0.0_near_2x3x5.par > $SIM_PATH/manybhnear_1bh_static_0.0_near_2x3x5.out
END=$(date +%s)
echo "Simulation ManyBHnear_1bh_static_0.0_near_2x3x5 end at "`date -u` >> SimulationStatus.out
