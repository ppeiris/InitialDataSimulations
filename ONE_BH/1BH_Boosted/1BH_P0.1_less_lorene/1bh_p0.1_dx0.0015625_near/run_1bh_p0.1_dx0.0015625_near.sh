...
# ==================================
START=$(date +%s)
echo "Simulation ManyBHmid_1bh_p0.1_dx0.0015625_near_4x5x9 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/manybhmid_1bh_p0.1_dx0.0015625_near_4x5x9.par > $SIM_PATH/manybhmid_1bh_p0.1_dx0.0015625_near_4x5x9.out
END=$(date +%s)
echo "Simulation ManyBHmid_1bh_p0.1_dx0.0015625_near_4x5x9 end at "`date -u` >> SimulationStatus.out
...
# ==================================
START=$(date +%s)
echo "Simulation ManyBHfar_1bh_p0.1_dx0.0015625_near_4x5x9 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/manybhfar_1bh_p0.1_dx0.0015625_near_4x5x9.par > $SIM_PATH/manybhfar_1bh_p0.1_dx0.0015625_near_4x5x9.out
END=$(date +%s)
echo "Simulation ManyBHfar_1bh_p0.1_dx0.0015625_near_4x5x9 end at "`date -u` >> SimulationStatus.out
