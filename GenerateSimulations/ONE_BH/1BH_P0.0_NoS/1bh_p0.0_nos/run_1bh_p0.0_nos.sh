...
# =====================================
START=$(date +%s)
echo "Simulation twopunnear_1bh_p0.0_nos_20 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunnear_1bh_p0.0_nos_20.par > $SIM_PATH/twopunnear_1bh_p0.0_nos_20.out
END=$(date +%s)
echo "Simulation twopunnear_1bh_p0.0_nos_20 end at "`date -u` >> SimulationStatus.out

START=$(date +%s)
echo "Simulation twopunnear_1bh_p0.0_nos_30 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunnear_1bh_p0.0_nos_30.par > $SIM_PATH/twopunnear_1bh_p0.0_nos_30.out
END=$(date +%s)
echo "Simulation twopunnear_1bh_p0.0_nos_30 end at "`date -u` >> SimulationStatus.out

START=$(date +%s)
echo "Simulation twopunnear_1bh_p0.0_nos_40 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunnear_1bh_p0.0_nos_40.par > $SIM_PATH/twopunnear_1bh_p0.0_nos_40.out
END=$(date +%s)
echo "Simulation twopunnear_1bh_p0.0_nos_40 end at "`date -u` >> SimulationStatus.out
...
# =====================================
START=$(date +%s)
echo "Simulation twopunmid_1bh_p0.0_nos_20 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunmid_1bh_p0.0_nos_20.par > $SIM_PATH/twopunmid_1bh_p0.0_nos_20.out
END=$(date +%s)
echo "Simulation twopunmid_1bh_p0.0_nos_20 end at "`date -u` >> SimulationStatus.out

START=$(date +%s)
echo "Simulation twopunmid_1bh_p0.0_nos_30 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunmid_1bh_p0.0_nos_30.par > $SIM_PATH/twopunmid_1bh_p0.0_nos_30.out
END=$(date +%s)
echo "Simulation twopunmid_1bh_p0.0_nos_30 end at "`date -u` >> SimulationStatus.out

START=$(date +%s)
echo "Simulation twopunmid_1bh_p0.0_nos_40 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunmid_1bh_p0.0_nos_40.par > $SIM_PATH/twopunmid_1bh_p0.0_nos_40.out
END=$(date +%s)
echo "Simulation twopunmid_1bh_p0.0_nos_40 end at "`date -u` >> SimulationStatus.out
...
# =====================================
START=$(date +%s)
echo "Simulation twopunfar_1bh_p0.0_nos_20 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunfar_1bh_p0.0_nos_20.par > $SIM_PATH/twopunfar_1bh_p0.0_nos_20.out
END=$(date +%s)
echo "Simulation twopunfar_1bh_p0.0_nos_20 end at "`date -u` >> SimulationStatus.out

START=$(date +%s)
echo "Simulation twopunfar_1bh_p0.0_nos_30 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunfar_1bh_p0.0_nos_30.par > $SIM_PATH/twopunfar_1bh_p0.0_nos_30.out
END=$(date +%s)
echo "Simulation twopunfar_1bh_p0.0_nos_30 end at "`date -u` >> SimulationStatus.out

START=$(date +%s)
echo "Simulation twopunfar_1bh_p0.0_nos_40 start at "`date -u` >> SimulationStatus.out
echo "Still working on ..." >> SimulationStatus.out
nohup ./bbhcode $SIM_PATH/twopunfar_1bh_p0.0_nos_40.par > $SIM_PATH/twopunfar_1bh_p0.0_nos_40.out
END=$(date +%s)
echo "Simulation twopunfar_1bh_p0.0_nos_40 end at "`date -u` >> SimulationStatus.out
